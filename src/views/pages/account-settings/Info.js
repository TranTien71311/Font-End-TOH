...
const languages = [
  { value: "english", label: "English", color: "#009bde" },
  { value: "french", label: "French", color: "#009bde" },
  { value: "spanish", label: "Spanish", color: "#009bde" },
  { value: "russian", label: "Russian", color: "#009bde" },
  { value: "italian", label: "Italian", color: "#009bde" }
]

const colourStyles = {
  control: styles => ({ ...styles, backgroundColor: "white" }),
  option: (styles, { data, isDisabled, isFocused, isSelected }) => {
    const color = data.color ? chroma(data.color) : "#009bde"
    return {
      ...styles,
      ...
      ":active": {
        ...styles[":active"],
        backgroundColor: !isDisabled && (isSelected ? data.color : "#009bde")
      }
    }
  },
  ...
  multiValueLabel: (styles, { data }) => ({
    ...styles,
    color: data.color ? data.color : "#009bde"
  }),
  multiValueRemove: (styles, { data }) => ({
    ...styles,
    color: data.color,
    ":hover": {
      backgroundColor: data.color ? data.color : "#009bde",
      color: "white"
    }
  })
}
